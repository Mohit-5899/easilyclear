...
class Settings(BaseSettings):
    ...
    model_ingestion: str = Field(
        ...
        "Default is the paid tier — :free was unreliable (consecutive 429 "
        "storms blocked Stage 4 entirely on 2026-05-01). Override with "
        "MODEL_INGESTION env var to test a different model.",
    )
